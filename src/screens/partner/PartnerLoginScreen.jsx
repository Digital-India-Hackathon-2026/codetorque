    ...
    <div style={{
      ...
      >
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 15, color: '#7B7B7B', fontWeight: 500, lineHeight: 1.5 }}>
            Manage your business and receive customer bookings.
          </p>
        </div>
        ...
        <div style={{ marginTop: 32, textAlign: 'center' }}>
          <p style={{ fontSize: 14, color: '#7B7B7B', fontWeight: 500 }}>
